...
<div class="beans-admin-container">
    <img class="beans-admin-logo"  src="https://trybeans.s3.amazonaws.com/static-v3/connect/img/app/logo-full-snow.svg" alt="snow-logo">
    <div class="welcome-panel beans-admin-content" style="max-width: 600px; margin: auto">
        <h1>Communicate with customers without disrupting their journey</h1>
        <p>
            Share information with online shoppers without requiring the impact of an overlay pop-up.
            <a href="https://<?php echo Helper::getDomain('WWW');?>/snow" target="_blank">Learn more about Snow</a></p>
        </p>

        <div>
            <div style="margin: auto;">
                <img src="<?php echo plugins_url('/assets/hero-image-snow.svg', BEANS_PLUGIN_FILENAME) ?>"
                     alt="snow-hero" width="95%">
            </div>
            <form method="get" class="beans-admin-form" action="https://<?php echo Helper::getDomain('CONNECT');?>/cms/woocommerce/snow/connect/">
                <p class="wc-setup-actions step" style="justify-content: center; display: flex">
					<?php if ( $beans_is_supported || $force): ?>
                    <button  type="submit" class="btn bg-primary shadow-md" value="Connect to Beans">
						<?php else: ?>
                ...
                <input type="hidden" name="redirect" value="<?php echo admin_url( 'admin.php?page=beans-woo-snow' );?>">
        ...
        <ul class="wc-wizard-features" id="config-status" style="display: None">
